 ...
 */
export default function PlayerMarker({ playerId, size, playerAvatar, position, color }: { playerId: string; size: number; playerAvatar: string; position: LatLng; color: string }) {
  const map = useMap();
