import { DivIcon, Icon, LatLng, LeafletEvent, LeafletMouseEvent } from "leaflet";
 ...
 */
export default function EnemyMarker({ id, size, playerAvatar, position }: { id: number; size: number; playerAvatar: string; position: LatLng }) {
  const map = useMap();
